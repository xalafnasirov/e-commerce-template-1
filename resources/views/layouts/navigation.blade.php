        ...
        <div class="container">
            <div class="header-nav">
                <div class="main-menu position-relative">
                    <ul>
                        <li class="title"><a href="{{ Route('home.index') }}">Home</a>
                        </li>
                        ...
                        <li class="dropdown position-static"><a href="#">Shop <i
                            ...
                            <ul class="mega-menu d-block">
                                <li class="d-flex">
                                    ...
                                    <ul class="d-block">
                                        <li class="title"><a href="#">Products 1</a></li>
                                        <li><a href="{{Route('product1.show')}}">Product Single</a></li>
                                        <li><a href="{{Route('product2.show')}}">Product Variable</a></li>
                                        <li><a href="{{Route('product3.show')}}">Product Affiliate</a></li>
                                        <li><a href="{{Route('product4.show')}}">Product Group</a></li>
                                        <li><a href="{{Route('product5.show')}}">Product Tab 2</a></li>
                                        <li><a href="{{Route('product6.show')}}">Product Tab 3</a></li>
                                    </ul>
                                    <ul class="d-block">
